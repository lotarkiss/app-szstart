...
const
  JsonData: array [0..3] of string = (
    ...
    '{"UUID":"{123e4567-e89b-12d3-a456-426614174003}","Kind":"rcon","Path":"/remote/rcon1","Name":"Remote Control","Description":"External RCON Endpoint","Protected":false,"NetworkMode":"tunnel","rcon_remoteHost":"localhost","rcon_remotePort":25575}'
  );
